function [cleanI, psnrout] = FeaEPLL_denoising(noisyI, noiseSD, alpha, prior, iterTime, groundI, gpuid)
...
for iter = 1:iterTime
    ...
    noiseCovs = noiseBascCov ./ betau ./(1+alpha);
    ...
    if iter < iterTime
        ...
        beta    = ((1 + beta)/(1+sqrt(beta)*(sqrt(alpha/(1+alpha)))))^2;
    end
end
