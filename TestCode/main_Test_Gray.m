...
temDataDir      = fullfile(pwd, 'testsets', 'noisy', 'Gray');
resultDir       = fullfile(pwd, 'results', 'denoising', 'Gray');
...
CompareMethod{2}  = 'EPLL_2048';
CompareMethod{3}  = 'FeaEPLL';
